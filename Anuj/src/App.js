...
const TxtContainer = React.lazy(() =>
  import("./components/Signup Page/TxtContainer")
);
const SignupForm = React.lazy(() =>
  import("./components/Signup Page/SignupForm")
);
const ChoosePlan = React.lazy(() =>
  import("./components/Signup Page/ChoosePlan")
);
    ...
    <div>
      <Suspense fallback={<div>Loading...</div>}>
        <Routes>
          ...
          <Route path="/play" element={<Video />}></Route>
        </Routes>
      </Suspense>
    </div>
  );
